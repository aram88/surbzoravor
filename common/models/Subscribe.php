...
class Subscribe extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('email','required','message'=>'Էլ․  հասցեն պարտադիր է'),
			array('email','email','message'=>'Սա Էլ հասցե չէ'),
			array('email','unique','message'=>'Այս Էլ․ հասցեով արդեն բաժանորդագրվել են'),
			array('hash', 'safe'),
