<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('sub_show')); ?>:</b>
	<?php echo CHtml::encode($data->sub_show); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('main_show')); ?>:</b>
	<?php echo CHtml::encode($data->main_show); ?>
	<br />
