<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('stick')); ?>:</b>
	<?php echo CHtml::encode($data->stick); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('home_page')); ?>:</b>
	<?php echo CHtml::encode($data->home_page); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('read_all')); ?>:</b>
	<?php echo CHtml::encode($data->read_all); ?>
	<br />
