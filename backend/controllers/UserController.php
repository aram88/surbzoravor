...
class UserController extends BackendController
{
	...
	{
		$model=new User;
		/*$model->email = 'adm@mail.ru';
		$model->username='zoravoradmin';
		$model->password ='SBZoravor@)!4';*/
		//$model->email = 'adsm@mail.ru';
		//$model->username='karineadmin';
		//$model->password ='KarinE2)!4';
		    $model->save();
		die;
